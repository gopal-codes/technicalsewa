...
const Location = () => {
  ...
  return (
    <div className="xsm:m-5 min-h-[500px]">
      ...
      <Topbar />
      <div className="flex flex-col md:h-[70vh] xsm:w-full md:w-[80rem] m-auto bg-gray-200 xsm:p-3 md:p-10 mt-5 xsm:gap-2 md:gap-5 rounded-lg">
            ...
            <div className="mt-2">
              ...
              <div className="flex flex-col">
                ...
                <div className="flex gap-5 mt-2  text-sm">
                  <span>{`Latitude: ${
                    address !== "N/A" ? clientLocation?.latitude : "N/A"
                  }`}</span>
                  <span>{`Longitude: ${
                    address !== "N/A" ? clientLocation?.longitude : "N/A"
                  }`}</span>
                </div>
              </div>
            </div>
